...
import Gsap from '../component/Gsap'; // ✅ Reusable animation
...
const ProgressSection = ({ label, data }) => (
  <div className="gsap-fade-in bg-white rounded-xl shadow p-6 border">
...
export default function Home() {
  ...
  return (
    <>
      <Gsap /> {/* ✅ Applies animation to all .gsap-fade-in */}

      <div className="min-h-screen bg-gray-50 px-4 py-10">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <h1 className="text-3xl font-bold mb-6 text-gray-800 gsap-fade-in">
            Dashboard Overview
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {data.leadStats.map((item, i) => (
              <div
                key={i}
                className="gsap-fade-in bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg transition"
              >
          ...
          {/* Progress & Customer Preview Sections */}
